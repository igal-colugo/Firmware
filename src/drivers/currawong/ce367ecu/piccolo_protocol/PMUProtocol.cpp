...
const char *PMUPackets_EnumLabel(int value)
{
    ...
    case PKT_PMU_MEASUREMENT_REQUEST:
        return translatePMU("PKT_PMU_MEASUREMENT_REQUEST");
    case PKT_PMU_SET_VA:
        return translatePMU("PKT_PMU_SET_VA");
    case PKT_PMU_SET_VP:
        return translatePMU("PKT_PMU_SET_VP");
    case PKT_PMU_SET_VS:
        return translatePMU("PKT_PMU_SET_VS");
    case PKT_PMU_SET_VB:
        return translatePMU("PKT_PMU_SET_VB");
    case PKT_PMU_SET_PP:
        return translatePMU("PKT_PMU_SET_PP");
    case PKT_PMU_SET_PS:
        return translatePMU("PKT_PMU_SET_PS");
    case PKT_PMU_SET_TO:
        return translatePMU("PKT_PMU_SET_TO");
    case PKT_PMU_SET_TU:
        return translatePMU("PKT_PMU_SET_TU");
    case PKT_PMU_SET_SO:
        return translatePMU("PKT_PMU_SET_SO");
    case PKT_PMU_SET_CT:
        return translatePMU("PKT_PMU_SET_CT");
    case PKT_PMU_SET_CA:
        return translatePMU("PKT_PMU_SET_CA");
    case PKT_PMU_SET_OUTPUT_STATES:
        return translatePMU("PKT_PMU_SET_OUTPUT_STATES");
    case PKT_PMU_ENABLE_OUTPUTS:
        return translatePMU("PKT_PMU_ENABLE_OUTPUTS");
    case PKT_PMU_DISABLE_OUTPUTS:
        return translatePMU("PKT_PMU_DISABLE_OUTPUTS");
    case PKT_PMU_SET_GENERATION_STATE:
        return translatePMU("PKT_PMU_SET_GENERATION_STATE");
    case PKT_PMU_START:
        return translatePMU("PKT_PMU_START");
    case PKT_PMU_STOP:
        return translatePMU("PKT_PMU_STOP");
    case PKT_PMU_RESET:
        return translatePMU("PKT_PMU_RESET");
    case PKT_PMU_SERIAL_NUMBER:
        return translatePMU("PKT_PMU_SERIAL_NUMBER");
    case PKT_PMU_FIRMWARE:
        return translatePMU("PKT_PMU_FIRMWARE");
    }
}
