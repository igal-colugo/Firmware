 ...
 */
void encodePMU_AuxiliaryErrorBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_AuxiliaryErrorBits_t *_pg_user)
{
 ...
 */
int decodePMU_AuxiliaryErrorBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_AuxiliaryErrorBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_AutronicErrorBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_AutronicErrorBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_AutronicErrorBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_AutronicErrorBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_ErrorBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_ErrorBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;

    // Error information for autronic processor
    encodePMU_AutronicErrorBits_t(_pg_data, &_pg_byteindex, &_pg_user->autronic);

    // Error information for auxiliary processor
    encodePMU_AuxiliaryErrorBits_t(_pg_data, &_pg_byteindex, &_pg_user->auxiliary);

    *_pg_bytecount = _pg_byteindex;

} // encodePMU_ErrorBits_t
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_ErrorBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_ErrorBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;

    // Error information for autronic processor
    if (decodePMU_AutronicErrorBits_t(_pg_data, &_pg_byteindex, &_pg_user->autronic) == 0)
        return 0;

    // Error information for auxiliary processor
    if (decodePMU_AuxiliaryErrorBits_t(_pg_data, &_pg_byteindex, &_pg_user->auxiliary) == 0)
        return 0;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_ThrottleDelayConfigBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_ThrottleDelayConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_ThrottleDelayConfigBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_ThrottleDelayConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_ThrottleConfigBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_ThrottleConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_ThrottleConfigBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_ThrottleConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_ThrottleCurveConfigBits_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_ThrottleCurveConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_ThrottleCurveConfigBits_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_ThrottleCurveConfigBits_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_PMUSettings_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_PMUSettings_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_PMUSettings_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_PMUSettings_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \param _pg_user is the data to encode in the byte array
 */
void encodePMU_CompileOptions_t(uint8_t *_pg_data, int *_pg_bytecount, const PMU_CompileOptions_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
 ...
 * \return 1 if the data are decoded, else 0.
 */
int decodePMU_CompileOptions_t(const uint8_t *_pg_data, int *_pg_bytecount, PMU_CompileOptions_t *_pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
